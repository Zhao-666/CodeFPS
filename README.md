...
- 实现绳索下降功能
- 实现爬梯功能
- 重构训练场Manager类，抽象出Base类
- 更新士兵模型
- 优化武器库灯光，降低SetPass calls 400
- 优化武器，手动换弹增加一发子弹
- 优化枪支横向后坐力
...
## 更新日志
1. 发布Beta v0.6版本
2. 修复实战训练场靶子会自动起立的bug
3. 修复新手训练场木板没有弹痕效果的bug
...
1. 研究Lighting系统（3h）
    ...
    - [Shadowmask模式介绍](https://www.bilibili.com/read/cv1474215/)
    - Shadowmask:
        - 静态物体烘培阴影，动态物体实时计算阴影。
        - 使用范围：中低端移动设备。
...
#### 遇到问题
**问题一**：目前场景的模型使用的是Mesh Collider，
如果不勾选Convex就无法勾选Is Trigger，子弹无法穿透木质场景。
