...
public class CombatChatText
{
    public static List<string> ChatTexts { get; } = new List<string>()
    {
        "<color=#00A45B>普莱斯队长：</color>很好。不过 “索普” 这算什么鸟名字？你这种菜鸟怎么也能过审查？",
        "<color=#00A45B>普莱斯队长：</color>索普，轮到你进行CQB测试了。其他人去观察台。",
        "<color=#00A45B>普莱斯队长：</color>这个测试要求你在60秒内完成整个货船模型的突袭。",
        "<color=#00A45B>普莱斯队长：</color>盖兹保持着19秒的全队记录。祝你好运。",
        "<color=#00A45B>普莱斯队长：</color>爬上那边的梯子。",
        
        "<color=#00A45B>普莱斯队长：</color>捡起MP5和闪光弹。（没有闪光弹，来不及做了）",
